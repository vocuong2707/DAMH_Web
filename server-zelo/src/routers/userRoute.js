...
const { findUser, getUsers, findUserByEmail, sendFriendRequest, acceptFriendRequestAndSendMessage, getFriends,
    getSendFriendRequest, deleteSendFriendRequest } = require("../controllers/userController");
